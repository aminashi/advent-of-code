...
//
//    splitLines = splitLines.sorted(by: {return $0.count < $1.count})
//    print(splitLines)
//        let newElement = line.last!
 //       let equation = line.first!
//        print(equation)
//        var currentOperator: Operations?
//        for operation in Operations.allCases {
//            if (equation.contains(operation.separator)) {
//                var equationString = equation.components(separatedBy: " ")
